"use strict";(self.webpackChunkgrafana=self.webpackChunkgrafana||[]).push([[6034],{90237:(b,d,l)=>{l.r(d),l.d(d,{default:()=>f});var n=l(9892),e=l(66111),m=l(81910),g=l(26418),i=l(72648),u=l(39904),p=l(45524);function f(){const t=(0,i.l4)(),a=(0,i.wW)(E);return e.createElement(p.J,{pageId:"alerting"},e.createElement("div",{className:a.grid},e.createElement(h,{className:a.ctaContainer}),e.createElement(s,{className:a.flowBlock},e.createElement("div",null,e.createElement("h3",null,"How it works"),e.createElement("ul",{className:a.list},e.createElement("li",null,"Grafana alerting periodically queries data sources and evaluates the condition defined in the alert rule"),e.createElement("li",null,"If the condition is breached, an alert instance fires"),e.createElement("li",null,"Firing instances are routed to notification policies based on matching labels"),e.createElement("li",null,"Notifications are sent out to the contact points specified in the notification policy"))),e.createElement(m.Z,{src:`public/img/alerting/at_a_glance_${t.name.toLowerCase()}.svg`,width:void 0,height:void 0})),e.createElement(s,{className:a.gettingStartedBlock},e.createElement("h3",null,"Get started"),e.createElement(g.Stack,{direction:"column",alignItems:"space-between"},e.createElement("ul",{className:a.list},e.createElement("li",null,e.createElement("strong",null,"Create an alert rule")," by adding queries and expressions from multiple data sources."),e.createElement("li",null,e.createElement("strong",null,"Add labels")," to your alert rules"," ",e.createElement("strong",null,"to connect them to notification policies")),e.createElement("li",null,e.createElement("strong",null,"Configure contact points")," to define where to send your notifications to."),e.createElement("li",null,e.createElement("strong",null,"Configure notification policies")," to route your alert instances to contact points.")),e.createElement("div",null,e.createElement(x,{href:"https://grafana.com/docs/grafana/latest/alerting/",title:"Read more in the Docs"})))),e.createElement(s,{className:a.videoBlock},e.createElement("iframe",{title:"Alerting - Introductory video",src:"https://player.vimeo.com/video/720001629?h=c6c1732f92",width:"960",height:"540",allow:"autoplay; fullscreen",allowFullScreen:!0,frameBorder:"0",style:{colorScheme:"light dark"}}))))}const E=t=>({grid:n.css`
  ...
  `});function c({title:t,description:a,href:r,hrefText:_}){const o=(0,i.wW)(v);return e.createElement("div",{className:o.container},e.createElement("h3",{className:o.title},t),e.createElement("div",{className:o.desc},a),e.createElement("div",{className:o.actionRow},e.createElement("a",{href:r,className:o.link},_)))}const v=t=>({container:n.css`
    flex: 1;
    min-width: 240px;
    display: grid;
    gap: ${t.spacing(1)};
  ...
  `});function s({children:t,className:a}){const r=(0,i.wW)(y);return e.createElement("div",{className:(0,n.cx)(r.box,a)},t)}const y=t=>({box:n.css`
    padding: ${t.spacing(2)};
    background-color: ${t.colors.background.secondary};
    border-radius: ${t.shape.borderRadius()};
  `});function x({href:t,title:a}){const r=(0,i.wW)(C);return e.createElement("a",{href:t,className:r.link,rel:"noreferrer"},a," ",e.createElement(u.J,{name:"angle-right",size:"xl"}))}const C=t=>({link:n.css`
    display: block;
    color: ${t.colors.text.link};
  `})}}]);

//# sourceMappingURL=AlertingHome.dcfd6d0df1d6302e8791.js.map